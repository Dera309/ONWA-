...
const config: Config = {
  ...
  theme: {
    ...
    extend: {
      ...
      fontSize: {
        "display-xl": ["80px", { lineHeight: "96px", letterSpacing: "-0.02em" }],
        "display-xl-mobile": ["48px", { lineHeight: "56px", letterSpacing: "-0.01em" }],
        "headline-lg": ["48px", { lineHeight: "56px" }],
        "headline-lg-mobile": ["32px", { lineHeight: "40px" }],
        "headline-md": ["32px", { lineHeight: "40px" }],
        "body-lg": ["18px", { lineHeight: "32px", letterSpacing: "0.01em" }],
